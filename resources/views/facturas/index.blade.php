...
<div class="mb-3 mt-1">
    <button class="btn btn-primary" data-toggle="modal" data-target="#createFacturaModal"><i class="bi bi-plus-circle-fill mr-2"></i>Crear nueva factura</button>
</div>
                    ...
                    <table id="facturasTable" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-toggle="modal" data-target="#showFacturaModal{{$f->factura_id}}">{{$f->cliente->nombre}}</td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#showFacturaModal{{$f->factura_id}}"><i class="fas fa-eye"></i></button>
                                    <button class="btn btn-warning btn-sm mx-2" data-toggle="modal" data-target="#editFacturaModal{{$f->factura_id}}"><i class="far fa-edit"></i></button>
